...
import de.mpii.gsm.localmining.Bfs;
...
public class BfsReducer extends Reducer<BytesWritable, IntWritable, IntArrayWritable, LongWritable> {
	...
	protected void setup(Context context) throws IOException {
		...
		bfs.setParametersAndClear(sigma, gamma, lambda, new NytTaxonomy(itemToParent));

	}

	/**
	 * Key is the partition id followed by sequence items and value is the weight
	 * of the sequence
	 */
	protected void reduce(BytesWritable key, Iterable<IntWritable> values, Context context) throws IOException,
